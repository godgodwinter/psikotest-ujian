  ...
  <nav class="rounded-md w-72 h-screen flex-col justify-between">
    <div class="bg-white h-full">
      <div class="flex justify-center py-10 shadow-sm pr-4">
        ...
        <div class="pl-2">
          <p class="text-2xl font-bold text-indigo-600">VENUS</p>
      ...
      <div class="pl-10">
        <ul class="space-y-8 pt-10">
          <li
            class="flex space-x-4 items-center hover:text-indigo-600 cursor-pointer"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-6 w-6"
    ...
    <div
      class="bg-white flex items-center space-x-4 pl-10 pb-10 hover:text-indigo-600 cursor-pointer"
    >
      <svg
        xmlns="http://www.w3.org/2000/svg"
        class="h-6 w-6"
